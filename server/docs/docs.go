    ...
    "paths": {
        ...
        "/api/public/code/getEmailCode": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "email_type可选值：EMAIL_TYPE_USER_REGISTER EMAIL_TYPE_USER_RESETPWD EMAIL_TYPE_TEST",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "model.CustomerService": {
            ...
            "properties": {
                ...
                "goods_id": {
                    "description": "OriginalAmount string ` + "`" + `json:\"original_amount\"  gorm:\"comment:原始金额\"` + "`" + `\n商品参数-基础参数",
                    "type": "integer"
                },
                "goods_type": {
                    "type": "string"
        ...
        "model.EpayPreCreatePay": {
            ...
            "properties": {
                ...
                "sign": {
                    "description": "签名字符串，所有参数按照参数名ASCII码从小到大排序（a-z），sign、sign_type、和空值不参与签名！sign = md5 ( a=b\u0026c=d\u0026e=f + KEY ) （注意：+ 为各语言的拼接符，不是字符！），md5结果为小写。",
                    "type": "string"
                },
                "sign_type": {
                    "description": "签名类型",
